...
import { getExportRequests, downloadExport } from '@/lib/api/dataManagement';
import type { DataExportRequest } from '@/types/dataManagement';
                        ...
                        <TableBody>
                            {requests.map((request) => (
                                <TableRow key={request.id}>
                                    ...
                                    <TableCell className="uppercase">{request.format}</TableCell>
