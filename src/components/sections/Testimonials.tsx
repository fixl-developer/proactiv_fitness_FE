        ...
        <section className="relative py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 overflow-hidden">
            ...
            <div className="container-max px-4 relative z-10">
                ...
                <div className="relative max-w-6xl mx-auto mb-16">
                    <motion.div
                        className="relative overflow-hidden rounded-3xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-2xl"
                            ...
                            >
                                <div className="grid md:grid-cols-3 gap-12 items-center">
                                    ...
                                    <div className="text-center md:text-left">
                                        ...
                                        >
                                            <motion.div
                                                className={`w-full h-full rounded-full ${testimonials[currentTestimonial].fallback} p-1`}
                                                animate={{
                                                    background: [
                ...
                <motion.div
                    ...
                    transition={{ duration: 1, ease: [0.25, 0.46, 0.45, 0.94] }}
                    viewport={{ once: true }}
                    className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-12 max-w-4xl mx-auto"
                >
                    {[
                        { number: "4.9/5", label: "Average Rating", sublabel: "Based on reviews", color: "from-blue-500 to-cyan-500", bg: "from-blue-50 to-cyan-50" },
                        { number: "98%", label: "Satisfaction Rate", sublabel: "Based on parent feedback", color: "from-green-500 to-emerald-500", bg: "from-green-50 to-emerald-50" },
                        { number: "200+", label: "Happy Families", sublabel: "Across both locations", color: "from-purple-500 to-pink-500", bg: "from-purple-50 to-pink-50" }
                    ].map((stat, index) => (
                        <motion.div
                            key={stat.label}
                            initial={{ opacity: 0, scale: 0.5 }}
                        ...
                        >
                            <motion.div
                                className={`bg-gradient-to-br ${stat.bg} rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-white/50 h-full flex flex-col justify-center`}
                            ...
                            >
                                ...
                                {/* Stars or Empty Space for Equal Height */}
                        ...
                        <div className="relative z-10">
                            ...
                            >
                                <motion.div whileHover={{ scale: 1.05, y: -3 }} whileTap={{ scale: 0.95 }}>
                                    <a
                                        href="/book-trial"
                                        className="group relative overflow-hidden bg-white text-blue-600 hover:bg-gray-50 px-10 py-4 rounded-2xl font-bold text-lg transition-all duration-300 shadow-xl flex items-center space-x-2"
                                    >
                                        <span>Book Free Trial</span>
                                        <FiStar className="w-5 h-5 group-hover:rotate-180 transition-transform duration-500" />
                                        <motion.div
                                ...
                                <motion.div whileHover={{ scale: 1.05, y: -3 }} whileTap={{ scale: 0.95 }}>
                                    <a
                                        href="/contact"
                                        className="group border-2 border-white text-white hover:bg-white hover:text-blue-600 px-10 py-4 rounded-2xl font-bold text-lg transition-all duration-300 flex items-center space-x-2"
                                    >
                                        <span>Contact Us</span>
                                        <FiMessageCircle className="w-5 h-5 group-hover:scale-125 transition-transform duration-300" />
                                    </a>
                                </motion.div>
                            </motion.div>
                        </div>
