    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 sm:pt-24">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <motion.div
                    className="absolute bottom-16 sm:bottom-24 left-1/2 transform -translate-x-1/2 z-20 flex space-x-2 sm:space-x-3"
                ...
                >
                    ...
                    >
                        {[
                            ...
                            >
                                <motion.div
                                    className="relative bg-white/15 backdrop-blur-xl border border-white/30 rounded-lg sm:rounded-xl p-3 sm:p-4 hover:bg-white/25 transition-all duration-500 shadow-2xl hover:shadow-white/20"
                                ...
                                >
                                    ...
                                    <motion.div
                                        className={`text-2xl sm:text-3xl md:text-4xl font-black mb-1 bg-gradient-to-r ${stat.color} bg-clip-text text-transparent drop-shadow-lg`}
                                    >
                                        <AnimatedCounter end={stat.number} duration={2.5} suffix={stat.suffix} />
                                    </motion.div>
                                    <div className="text-[10px] sm:text-xs font-bold text-white uppercase tracking-wider drop-shadow-md">{stat.label}</div>
