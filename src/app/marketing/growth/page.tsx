                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="space-y-3">
                                <Button onClick={() => router.push('/marketing/growth/funnel')} className="w-full justify-start bg-blue-50 text-blue-600 hover:bg-blue-100">
                                    View Funnel Analysis
                                </Button>
                                <Button onClick={() => router.push('/marketing/growth/acquisition')} className="w-full justify-start bg-green-50 text-green-600 hover:bg-green-100">
                                    View Acquisition Channels
                                </Button>
                                <Button onClick={() => router.push('/marketing/growth/retention')} className="w-full justify-start bg-purple-50 text-purple-600 hover:bg-purple-100">
                                    View Retention Analysis
                                </Button>
                                <Button onClick={() => router.push('/marketing/growth/metrics')} className="w-full justify-start bg-orange-50 text-orange-600 hover:bg-orange-100">
