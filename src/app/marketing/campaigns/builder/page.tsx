                    ...
                    <CardContent>
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="select-marketing-campaigns-builder-3"
                                    value={campaignType}
                            ...
                            <div className="flex gap-3">
                                <Button id="btn-save-marketing-campaigns-builder" onClick={handleSave} disabled={saving} className="bg-blue-600 hover:bg-blue-700 text-white">
                                    <Save className="w-4 h-4 mr-2" />
                                    {saving ? 'Saving...' : 'Save Campaign'}
                                </Button>
                                <Button id="btn-router-marketing-campaigns-builder" variant="outline" onClick={() => router.push('/marketing/campaigns')}>
                                    Cancel
                                </Button>
                            </div>
                        </div>
