    ...
    return (
        <CMSCrudTable
            ...
            fields={[
                ...
                { name: 'slug', label: 'Slug', type: 'slug', required: true, placeholder: 'cyberport', maxLength: 80, showInTable: true, deriveFrom: 'name', helpText: 'Auto-generated from name. Lowercase letters, numbers and hyphens only. Must be unique.' },
                ...
                { name: 'images', label: 'Images', type: 'image-array', helpText: 'Upload images or paste URLs. These appear on the location detail page.' },
