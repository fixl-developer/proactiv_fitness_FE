    ...
    <div className="p-6 space-y-6 max-w-[1400px] mx-auto">
      {error && (
        ...
        >
          ...
          <Button id="btn-fetch-data-admin-reports-audit" variant="outline" size="sm" onClick={fetchData} className="ml-auto gap-1.5 text-red-700 border-red-300 hover:bg-red-100">
