                ...
                >
                    <div className="flex items-center justify-between px-6 py-4">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-xl font-semibold text-gray-900">Regional Dashboard</h1>
                        ...
                        <div className="flex items-center space-x-3">
                            <NotificationBell />
                            <Button id="btn-admin-regional-settings" variant="outline" size="sm" onClick={() => router.push('/admin/regional/settings')}>
