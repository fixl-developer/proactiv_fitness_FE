    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
                ...
                {results.churn && <div className="p-2 bg-green-50 rounded text-xs"><p className="font-medium text-green-700">Churn Risk:</p><p>{results.churn.data?.riskLevel || results.churn.data?.message || formatAIResponse(results.churn.data, 100)}</p></div>}
                {results.ltv && <div className="p-2 bg-green-50 rounded text-xs"><p className="font-medium text-green-700">LTV:</p><p>{results.ltv.data?.predictedLTV || results.ltv.data?.message || formatAIResponse(results.ltv.data, 100)}</p></div>}
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
                ...
                {results.promo && <div className="p-2 bg-indigo-50 rounded text-xs"><p className="font-medium text-indigo-700">Generated:</p><p>{results.promo.data?.content || results.promo.data?.post || results.promo.data?.message || formatAIResponse(results.promo.data, 150)}</p></div>}
            </div>
        </div>
    )
}
