    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <Link id="admin-schedule-classes" href="/admin/schedule/classes" className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
                    <h3 className="text-lg font-semibold mb-2">Classes</h3>
                    <p className="text-gray-600">Manage class schedules</p>
                </Link>
                <Link id="admin-schedule-assign-coaches" href="/admin/schedule/assign-coaches" className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
                    <h3 className="text-lg font-semibold mb-2">Assign Coaches</h3>
                    <p className="text-gray-600">Assign coaches to classes</p>
                </Link>
                <Link id="admin-schedule-assign-rooms" href="/admin/schedule/assign-rooms" className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
                    <h3 className="text-lg font-semibold mb-2">Assign Rooms</h3>
                    <p className="text-gray-600">Assign rooms to classes</p>
                </Link>
                <Link id="admin-schedule-conflicts" href="/admin/schedule/conflicts" className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
