        ...
        <DashboardLayout userRole="admin" userName={userName} userEmail={userEmail}>
            <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <Button id="btn-set-show-form-admin-terms" onClick={() => setShowForm(true)} className="bg-gradient-to-r from-blue-600 to-purple-600">
                ...
                {showForm && (
                    ...
                    >
                        ...
                        <form id="form-admin-terms" onSubmit={handleSubmit} className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="select-admin-terms-4"
                            ...
                            <div className="flex gap-3">
                                <Button id="admin-terms-btn" type="submit" className="bg-gradient-to-r from-green-600 to-emerald-600">
                                    {editingId ? 'Update Term' : 'Create Term'}
                                </Button>
                                <Button id="btn-reset-form-admin-terms" type="button" onClick={resetForm} variant="outline">
                                    Cancel
                                </Button>
                            </div>
                        </form>
                    ...
                    {terms.length === 0 ? (
                        <Card>
                            <CardContent className="p-12 text-center">
                                ...
                                <Button id="btn-set-show-form-admin-terms" onClick={() => setShowForm(true)}>Create Term</Button>
                            </CardContent>
                        </Card>
                    ) : (
