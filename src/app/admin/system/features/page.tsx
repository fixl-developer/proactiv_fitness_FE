            ...
            <Card>
                <CardContent className="p-4">
                    <div className="relative">
                        ...
                        <input id={`input-text-admin-system-features-${stat.label.toLowerCase().replace(/\s+/g, '-')}`} type="text" placeholder="Search feature flags..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all" />
                    </div>
                </CardContent>
            </Card>
