    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => openRoomForm()}>
        ...
        <Card>
          <CardContent className="p-12">
            <div className="text-center">
              ...
              {!searchTerm && (
                <Button className="mt-4" onClick={() => openLocationForm()}>
                  <Plus className="w-4 h-4 mr-2" />
                  Add Location
                </Button>
              )}
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                              ...
                              {locationRooms.map((room) => (
                                ...
                                >
                                  ...
                                  <div className="flex gap-1">
                                    <Button variant="ghost" size="sm" onClick={() => openRoomForm(room)}>
                      ...
                      <div className="flex gap-2">
                        <Button variant="outline" className="flex-1" onClick={() => openLocationForm(location)}>
