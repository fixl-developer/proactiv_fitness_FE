...
export default function KnowledgeBase() {
    ...
    const handleSearch = async () => {
        ...
        try {
            const results = await StaffManagementService.searchKnowledgeBase(searchQuery)
            setArticles(results)
        } catch (err) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-8">
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <button id="staff-knowledge-btn" className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 flex items-center gap-2">
